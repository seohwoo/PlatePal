      ...
      const messages = [
        { role: "system", content: "You are a helpful assistant." },
        {
          ...
          content: `재료:' + ${ingredients.join(
            ", "
          )} + 'if 재료가 모두 음식이라면 재료를 포함해서 만들 수 있는 요리 이름을 한단어로 말해주고, 필요한 재료들을 알려줘. 이 때 만드는 방법은 말하지 마. 출력형식은 " 숫자. 메뉴이름 : 재료"이고, 개수는 무조건 4개 생성해줘. 생성 후에는 다른 문장은 출력하지마. else 재료가 음식이 아니라면 오류를 출력해줘. 오류 출력형식은 "정확한 재료를 입력해 주세요" 딱 이 한 문장이고, 다른 문장은 절대 출력하지마. (if, else 문에서 지시한 문장이 아니라면 어떠한 문장도 출력하지 마)`,
        },
      ];
